            ...
            <div className="flex items-center justify-center">
              <div className="w-full">
                <input
                  ...
                  className="w-60 py-3 px-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all text-center text-lg font-medium placeholder:text-gray-400"
                />
              </div>
            </div>
            <Button 
